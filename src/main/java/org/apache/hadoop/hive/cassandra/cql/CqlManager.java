...
public class CqlManager {
  ...
  public void createColumnFamily() throws MetaException {
    try {
        ...
        String columnsStr = (String) properties.get(org.apache.hadoop.hive.metastore.api.hive_metastoreConstants.META_TABLE_COLUMNS);
        String columnTypesStr = (String) properties.get(org.apache.hadoop.hive.metastore.api.hive_metastoreConstants.META_TABLE_COLUMN_TYPES);
